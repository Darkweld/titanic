...
function TitanicText ({started, height, textRef}) {
  return (
    <div className = {(started) ? style.textContainerStarted : style.textContainer} style = {{height: height}} ref = {textRef}>
