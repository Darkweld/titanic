...
function TitanicText ({bool, height, textRef}) {
  return (
    <div className = {(bool) ? style.textContainerSubmerged : style.textContainer} style = {{height: height}} ref = {textRef}>
      ...
      <div className = {style.textDiv}>
        ...
        <img src = "../images/titanic01.jpg" className = {style.picture} style = {{float: "right"}}></img>
      </div>
